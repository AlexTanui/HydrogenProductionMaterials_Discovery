...
Deep learning (graph neural networks) and causal machine learning to
accelerate discovery of hydrogen production materials — predicting
catalytic activity and stability across large chemical spaces to replace
slow, resource-intensive traditional screening.

This repo currently holds **structure only** — folders and empty
placeholder files, no implementation yet.
